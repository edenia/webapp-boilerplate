...
const BPJsonForm = ({ accountName, bpJson, onSubmit }) => {
  ...
  return (
    <Box>
      <Typography variant="h2">BP JSON Generator</Typography>
      <Typography variant="body1">
        A simple way to create and update your node information on chain.
      </Typography>
      <Box height={30} />
      {accountName && (
        <Typography variant="h2">{`Account Name: ${accountName}`}</Typography>
      )}
      ...
      <Box className={classes.jsonView}>
        <Typography variant="h2">Block Producer JSON preview</Typography>
